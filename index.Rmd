...
Using the code `trees[trees$Girth < 12.5, ]`, we can see that there are `r nrow(trees[trees$Girth < 12.5, ])` trees with a girth less than 12.5
 ...
 * It is NRCS data of soil around Indonesia
* Things to try:
 * Read in the data
